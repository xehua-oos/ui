...
local ae = aa:CreateWindow{
    ...
    Background = "https://raw.github.com/xehua-oos/WindUI/blob/d7f989d0f46fb2dfb6a316ef7e22c31606fdd194/Image_1771151649001.jpg",  -- ← 添加这一行
    NewElements = true,
    HideSearchBar = false,
    OpenButton = {
        Title = "坤坤大帝 Hubris",
