...
local ae = aa:CreateWindow{
    ...
    Background = "https://github.com/xehua-oos/WindUI/blob/d7f989d0f46fb2dfb6a316ef7e22c31606fdd194/Image_1771151649001.jpg",  -- ← 添加这一行
    NewElements = true,
    HideSearchBar = false,
    OpenButton = {
        Title = "坤坤大帝 Hubris",
...
do
    ...
    local round = aa.NewRoundFrame(8, "Squircle", {
        Size = UDim2.new(1, 0, 1, 0),
        Parent = marqueeFrame,
        ImageColor3 = Color3.new(1, 1, 1),
