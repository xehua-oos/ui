				...
				ab.NewRoundFrame(am, not ak and "SquircleOutline" or "SquircleOutline2", {
					...
					ac("UIGradient", {
						...
						Color = ColorSequence.new{
							ColorSequenceKeypoint.new(0.0, Color3.fromRGB(255, 255, 0)),
							ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 255, 0)),
							ColorSequenceKeypoint.new(1.0, Color3.fromRGB(255, 255, 0)),
						},
		...
		function ac.New(ak, al, am, an, ao)
			...
			local as = ag("TextButton", {
				...
				ae.NewRoundFrame(ap.Radius - 4, "Squircle", {
					ImageColor3 = Color3.fromHex"#FFFFE0",
					ImageTransparency = 1,
					Size = UDim2.new(1, 0, 1, 0),
					AnchorPoint = Vector2.new(0.5, 0.5),
					Position = UDim2.new(0.5, 0, 0.5, 0),
			...
			local at = ae.NewRoundFrame(ap.Radius, "Squircle", {
				...
				ag("Frame", {
					...
					ae.NewRoundFrame(ap.Radius, "Squircle-TL-TR", {
						...
						ag("TextLabel", {
							Text = al,
							TextColor3 = Color3.fromHex"#FFFFE0",
							TextTransparency = .2,
							TextSize = 16,
							AutomaticSize = "Y",
